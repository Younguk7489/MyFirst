...
std::string HelpMessage()
{
    ...
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: soomcoin4d.pid)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 13800 or testnet: 23800)") + "\n";
...
strUsage += "\n" + _("Masternode options:") + "\n";
    ...
    strUsage += "  -anonymizeSoomcoinamount=<n> " + _("Keep N Soomcoin anonymized (default: 0)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Soomcoin is probably already running."), strDataDir));
    ...
    nAnonymizeSoomcoinAmount = GetArg("-anonymizeSoomcoinamount", 0);
    if(nAnonymizeSoomcoinAmount > 999999) nAnonymizeSoomcoinAmount = 999999;
    if(nAnonymizeSoomcoinAmount < 2) nAnonymizeSoomcoinAmount = 2;
    ...
    if(fEnableInstantX){
        ...
        if(nInstantXDepth < 0) nAnonymizeSoomcoinAmount = 0;
    } else {
        nInstantXDepth = 0;
    }
    ...
    LogPrintf("Anonymize Soomcoin Amount %d\n", nAnonymizeSoomcoinAmount);

    /* Denominations
       A note about convertability. Within Darksend pools, each denomination
       is convertable to another.
       For example:
       1Soomcoin+1000 == (.1Soomcoin+100)*10
       10Soomcoin+10000 == (1Soomcoin+1000)*10
    */
