...
int nAnonymizeSoomcoinAmount = 500;
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "soomcoin4";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "soomcoin4d.pid"));
